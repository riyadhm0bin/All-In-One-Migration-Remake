...
if (!defined('DUPLICATOR_PLUGIN_DIRNAME')) {
    define('DUPLICATOR_PLUGIN_DIRNAME', plugin_basename(dirname(__FILE__)));
}
if (!defined('DUPLICATOR_PLUGIN_VERSION')) {
    define('DUPLICATOR_PLUGIN_VERSION', '1.0.0');
}
    ...
    class duplicate_page
    {
        ...
        */
        public function __construct()
        {
            ...
            add_filter('plugin_action_links', array(&$this, 'duplicator_plugin_action_links'), 10, 2);
